...
```bash
/root/sandbox/codex-cli/context/
...
| Action       | Location                           |
| ------------ | ---------------------------------- |
| Save memory  | `/root/sandbox/codex-cli/memory/`  |
| Save context | `/root/sandbox/codex-cli/context/` |
| Save output  | `/root/sandbox/codex-cli/output/`  |
| Temp files   | `/root/sandbox/codex-cli/temp/`    |
| Logs         | `/root/sandbox/codex-cli/logs/`    |
